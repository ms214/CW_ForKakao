  <?php
    function lfmeal($days){
      ...
      // 그에 따라 <어제 급식> 메뉴는 삭제해버림
        ...
        $URL = "https://stu.sen.go.kr/sts_sci_md01_001.do?schulCode=B100000544&&schulCrseScCode=4&schMmealScCode=2&schYmd=" . $date; // DOMDocument
        // url 생성
